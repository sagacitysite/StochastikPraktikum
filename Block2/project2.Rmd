...
ergibt sich die mittlere Power für $m= nSim = 10⁴$ Monte-Carlo-Simulationen als $\beta_m  = \frac{1}{m}\sum_{i=1}^{m}{\phi_i} = \frac{1}{m}\sum_{i=1}^{m}{1(p_i<\alpha)}$.
...
```{r Nadaraya-Watson-estimator Test, cache = TRUE}
