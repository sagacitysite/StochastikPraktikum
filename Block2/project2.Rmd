...
Wir können sehen, dass die Wahl des Kerns die Glattheit der geschätzten Dichtefunktion beeinflusst. Da der Rechteckskern sowie der Epanechnikov-Kern den Träger $[-1,1]$ (bzw. $(-1,1)$) besitzen, finden sich Sprünge in den geschätzten Dichten. Da (mit $h$ skalierte) Differenzen in $[-1,1]$ für den Rechtseckskern gleich gewichtet werden sind die geschätzten Dichten nochmals sprunghafter im Vergleich zum Epanechnikov-Kern welcher symmetrisch um 0 monoton abfällt, was eine Glättung zur Folge hat.
