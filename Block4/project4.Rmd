...
```{r simulate drunk bird and human}
# TODO: only use positive values on z-axis!
# TODO: enable other destinations than 0 (or not, actually)
...
human1 <- fnRandomWalk(2, c(10,10), 1000, 3)
p1 <- ggplot(human1, aes(x=human1[1], y=human1[2], color=human1[3])) + geom_path()
p1

bird1 <- fnRandomWalk(3, c(10,10,10), 1000, 3)
p2 <- ggplot(bird1, aes(x=bird1[1], y=bird1[2], z=bird1[3], color=bird1[4])) + geom_path()
p2

fnRandomMC <- function(nSamples, nSim) {
